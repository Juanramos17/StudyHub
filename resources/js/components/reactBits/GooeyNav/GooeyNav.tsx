...
interface GooeyNavItem {
    label: string;
    href: string;
    onClick?: (e: React.MouseEvent<HTMLLIElement>) => void; // nuevo opcional
}
...
const GooeyNav: React.FC<GooeyNavProps> = ({
    ...
    @media (max-width: 640px) {
      ...
      .effect.filter {
        color: transparent; /* Oculta texto duplicado */
      }
    }
  `}
            </style>
                ...
                <nav className="relative flex" style={{ transform: 'translate3d(0,0,0.01px)' }}>
                    ...
                    >
                        {items.map((item, index) => (
                            ...
                            >
                                <a href={item.href} onKeyDown={(e) => handleKeyDown(e, index)} className="outline-none">
                                    {item.label}
                                </a>
                            </li>
                        ))}
